export const CATEGORIZED_PALETTES = [
    {
        ...
        palettes: [
            ...
            // Stripe-Inspired
            ["#635BFF", "#00BFFF", "#E5E5E5", "#0A2540", "#00C7B7"],

            // Linear-Inspired (Dark Mode Friendly)
            ["#0F0F10", "#1E1E20", "#2D2D2F", "#7F5AF0", "#72757E"],

            // Vercel/Next.js Vibe
            ["#000000", "#333333", "#888888", "#E5E5E5"],

            // Notion-Inspired Minimalism
            ["#F5F5F5", "#E0E0E0", "#2F3437", "#111111"],

            // Figma-Inspired Playful Brand
            ["#0ACF83", "#A259FF", "#F24E1E", "#FF7262", "#1ABCFE"],

            // Linear Light Mode
            ["#F3F4F6", "#E5E7EB", "#7F5AF0", "#3F3F46"],

            // Intercom-Inspired
            ["#0069FF", "#1F2D3D", "#E1E8ED", "#F5F8FA", "#007BFF"],

            // Framer-Inspired
            ["#000000", "#121212", "#232323", "#3B82F6", "#FFFFFF"],

            // Clean SaaS UI
            ["#3B82F6", "#2563EB", "#F9FAFB", "#1E3A8A", "#111827"],

            // Cool Neutrals + Accent
            ["#111827", "#374151", "#6B7280", "#D1D5DB", "#3B82F6"],
        ],
    },
    {
        category: "E-commerce",
